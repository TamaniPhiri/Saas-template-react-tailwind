...
const Hero = () => {
  return (
    <div className="flex items-center flex-col min-h-screen relative justify-center w-full px-4 md:px-12">
      ...
      />
      <div>
        <h1 className="text-[52px] leading-tight mb-4 md:text-[62px] lg:text-[72px] text-center font-bold">Build your very own SaaS <br className="lg:block"/> website with <span className="bg-clip-text text-transparent bg-gradient-to-b from-lime-400 via-white to-purple-500">Dalma</span></h1>
